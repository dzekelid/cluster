...
- name: Google Cloud Dataproc API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/cluster/master/_listings/google-cloud-dataproc/v1-projects-projectid-regions-region-clusters-clustername-get.md
x-common:
- type: x-change-logs
