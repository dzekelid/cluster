...
created: "2018-03-13"
modified: "2018-03-13"
url: https://raw.githubusercontent.com/streamdata-gallery/cluster/master/_listings/google-cloud-dataproc/apis.yaml
...
- name: Google Cloud Dataproc API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/cluster/master/_listings/google-cloud-dataproc/v1-projects-projectid-regions-region-clusters-clustername-diagnose-post.md
x-common:
- type: x-change-logs
