...
- name: Google Container Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/cluster/master/_listings/google-container-engine/v1-projects-projectid-zones-zone-clusters-post.md
x-common:
- type: x-change-log
